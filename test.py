...
def main():
    ...
    #label, k , eps,eps_step, clip_min ,clip_max
    #eps, eps_step, k, label, clip_min,clip_max
    parser.add_argument("--eps", help="attack change bound", type=int, default=0.08)
    parser.add_argument("--eps_step", help="pgd step size", type=int, default=0.05)
    ...
    parser.add_argument("--clip_min", help="input bound", type=int, default=0)
    parser.add_argument("--clip_max", help="input bound", type=int, default=1)
